...
<body>
    <header role="banner" class="flex flex-col items-center relative top-4">
        <nav
            class="w-[90%] absolute flex flex-row justify-around items-center rounded-[45px] backdrop-blur-sm bg-white/10 border border-white/20">
            <a href="index.html" aria-label="Ir al inicio">
                <img src="resources/icon/Cargatel-logo-horizontal.svg" alt="Logo horizontal de Cargatel" width="350"
                    height="75" class="" />
            </a>
            <ul class="flex flex-row gap-4 list-none">
                <li><a href="index.html" class="text-[#1c3462] text-base"
                        title="Inicio de Cargatel, fletes y mudanzas">Inicio</a></li>
                <li><a href="cotizacion.html" class="text-[#1c3462] text-base"
                        title="Solicita tu cotización de flete o mudanza en León">Cotización</a></li>
                <li><a href="#flota" class="text-[#1c3462] text-base"
                        title="Conoce nuestra flota de transporte">Flota</a></li>
                <li><a href="#contact" class="text-[#1c3462] text-base"
                        title="Servicios de mudanza y flete local o foráneo">Servicios</a></li>
                <li><a href="nosotros.html" class="text-[#1c3462] text-base"
                        title="Quiénes somos en Cargatel">Nosotros</a></li>
                <li><a href="#contacto" class="text-[#1c3462] text-base"
                        title="Formulario de contacto para tu envío">Contacto</a></li>
            </ul>
            <button type="button"
                class="backdrop-blur-sm bg-[#111928]/15 text-[#1c3462] border border-white/20 rounded-[45px] px-4 py-2 text-[1.1rem] font-semibold cursor-pointer">Cotizar</button>
        </nav>
    </header>

    <main>
        <section id="first-section"
            class="flex flex-col items-center justify-center w-full h-screen relative text-center">
            ...
            <h2 class="text-[#1c3462] w-[70%] text-[clamp(1.5rem,6vw,5.4rem)] font-bold px-4 py-16">Solucionamos tus
                mudanzas y fletes en todo el país</h2>
            ...
            <button type="button"
                class="backdrop-blur-sm bg-[#111928]/15 text-[#eeeeee] border border-white/20 rounded-[45px] px-4 py-2 text-[clamp(0.9rem,2.5vw,1.1rem)] cursor-pointer m-4">Solicita
                tu cotización gratuita</button>
        </section>
        <section id="second-section" class="flex flex-col items-center justify-center w-full h-[50vh] text-center">
            ...
            <a href="#about"
                class="backdrop-blur-sm bg-[#111928]/15 text-[#1c3462] border border-white/20 rounded-[45px] px-4 py-2 text-[1.1rem] font-semibold cursor-pointer m-4"
                role="button" aria-label="Ir al formulario para cotizar tu mudanza o flete">
                Cotizar ahora
            </a>
        </section>
        <section id="third-section" class="flex items-center justify-center w-full h-screen">
            <section
                class="w-[90%] h-[90%] bg-cover bg-center rounded-[45px] overflow-hidden flex items-center justify-start"
                style="background-image: url('resources/img/IMG-20250614-05.jpg');">
                <div
                    class="w-full max-w-[1100px] h-full bg-gradient-to-r from-[#1c346280] to-transparent flex items-center justify-start p-20">
                    <div class="text-[#eeeeee] max-w-[700px] max-h-[900px]">
                        <p class="text-[clamp(.9rem,2.2vw,1rem)] opacity-90 p-4">Conoce nuestra flota de unidades y
                            elige la que mejor se adapte a tus necesidades</p>
                        <h2 class="text-[#1c3462] text-[2.5rem] font-bold p-4">Flota</h2>
                        <p class="text-[#eeeeee] text-[1.1rem] leading-relaxed p-4">
                            En Cargatel contamos con una amplia gama de vehículos diseñados para satisfacer todo tipo de
                            servicio:
                            desde cargas ligeras hasta mudanzas industriales.
                        </p>
                        <button
                            class="backdrop-blur-sm bg-[#111928]/15 text-[#eeeeee] border border-white/20 rounded-[45px] px-4 py-2 text-[clamp(0.9rem,2.5vw,1.1rem)] cursor-pointer m-4">Conoce
                            nuestra flota</button>
                        <div class="mt-4">
        ...
        <section id="fourth-section" class="w-full h-[75vh] flex flex-col items-center justify-center text-center">
            ...
            <article class="flex flex-row items-center justify-center gap-[50px] p-12">
                <div
                    class="w-1/4 h-[440px] backdrop-saturate-200 bg-[#eeeeee]/75 border border-white/20 rounded-[45px] flex flex-col justify-center items-center p-2">
                    ...
                    <button
                        class="backdrop-blur-sm bg-[#111928]/15 text-[#1c3462] border border-white/20 rounded-[45px] px-4 py-2 text-[1.1rem] font-semibold cursor-pointer m-2"
                        aria-label="Solicitar servicio de logística">
                        Solicitar Logística
                    </button>
                </div>
                <div
                    class="w-1/4 h-[440px] backdrop-saturate-200 bg-[#eeeeee]/75 border border-white/20 rounded-[45px] flex flex-col justify-center items-center p-2">
                    <img src="resources/img/IMG-20250614-11.jpg"
                        alt="Repartidor de Cargatel entregando paquete a domicilio"
                        class="w-full object-cover rounded-[45px]" width="383" height="200" loading="lazy">
        ...
        <section id="fifth-section"
            class="bg-[#eeeeee] flex flex-col justify-center items-center w-full h-[75vh] text-center">
            ...
            <article class="flex flex-row items-center justify-center w-full">
                <div class="w-[460px] p-8">
                    ...
                    <p class="text-[1.2rem] p-2 text-[#1c3462]">
                        Contáctanos y uno de nuestros especialistas se comunicará contigo para resolver tus dudas o
                        ayudarte a elegir el mejor servicio.
                    </p>
                </div>
                <div class="w-[460px] p-8">
                    <img src="resources/img/IMG-20250614-03.webp" alt="Especialista de Cargatel atendiendo a cliente"
                        width="640" height="480" class="rounded-[45px] w-full h-auto">
                </div>
            </article>
        </section>
    ...
    <footer role="contentinfo" class="flex flex-col items-stretch justify-evenly p-12 w-full bg-[#eeeeee]">
        <div class="flex justify-around flex-wrap">
            ...
            <nav aria-label="Soporte">
                ...
                <ul>
                    ...
                    <li class="py-2"><a href="#" class="text-[#58570E] hover:underline">Preguntas
                            frecuentes</a></li>
                </ul>
            </nav>
            <section aria-label="Información de contacto">
                ...
                <address class="flex flex-col items-start justify-around">
                    ...
                    <a href="mailto:contacto@cargatel.com"
                        class="text-[#58570E] hover:underline">contacto@cargatel.com</a>
                </address>

                <h2 class="text-[1.9rem] font-bold text-[#1c3462] py-4">Síguenos</h2>
                <ul class="flex flex-row gap-4 items-center text-[#58570E]">
                    <li>
                        <a href="https://www.facebook.com/p/Cargatel-SA-de-CV-100063975362978/" target="_blank"
                            rel="noopener noreferrer" aria-label="Facebook de Cargatel">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                                class="bi bi-facebook" viewBox="0 0 16 16" fill="currentColor">
                                <path
                    ...
                    <li>
                        <a href="https://www.instagram.com/cargatel.mx" target="_blank" rel="noopener noreferrer"
                            aria-label="Instagram de Cargatel">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28"
                                class="bi bi-instagram" viewBox="0 0 16 16" fill="currentColor">
                                <path
        ...
        <figcaption class="text-left text-[4rem] text-[#1c3462] flex flex-row items-center mt-8">
            <img src="resources/icon/Cargatel-imagen.svg" alt="Logotipo institucional de Cargatel" width="550"
                height="375">
